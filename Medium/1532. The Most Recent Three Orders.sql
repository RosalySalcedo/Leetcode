...
# top 3
# each user ( group by user)
# order < 3 then retuen all orders
...
with temp as (
    select
        ...
        o.order_id ,
        o.order_date,
        rank() over(partition by c.customer_id order by o.order_date desc ) as rkd
    from orders o
        join customers c
